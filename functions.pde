  ...
  if ((found_session_id) && (!found_CSV)){
    ...
    if (found != 0){
      ...
      for (int i = 0; i < REMOTE_FEED_DATASTREAMS; i++){
        ...
        device0_state = remoteSensor[0];
        device1_state = remoteSensor[1];
        device2_state = remoteSensor[2];
      
        Serial.println();
        Serial.print("remote value 1 =");
        Serial.println(device0_state);
        Serial.print("remote value 2 =");
        Serial.println(device1_state);
        Serial.print("remote value 3 =");
      ...
      device0_current = device0_state;
      device1_current = device1_state;
      device2_current = device2_state;
